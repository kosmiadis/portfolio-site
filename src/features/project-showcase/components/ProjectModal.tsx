            ...
            <div className="text-foreground-primary relative p-2 flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 laptop:grid-cols-2 gap-5 p-4 laptop:p-0">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {openProject.live && <div className="flex flex-col gap-2">
                            <h2 className="important-heading">Live Preview</h2>
                            <div className="flex flex-wrap gap-1.5">
                                <a target="_blank" className="hover:text-accent" href={openProject.live}>{openProject.live}</a>
                            </div>
                        </div>}

    ...
    return <Page>
        <div>
            <div className="flex flex-col mb-4">
                <motion.h1 className="page-hero-text" initial={animationVariants.fadeOut} animate={animationVariants.fadeIn} transition={animationVariants.transitions}>Hello There!</motion.h1>
                <div>
